CREATE DATABASE  IF NOT EXISTS `bdrenta` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `bdrenta`;
...
INSERT INTO `automovil` VALUES ('AWT-931','Koleos','Azul Marino',2017,5,24571,2,7,4),('AZB-456','Golf','Azul Marino',2010,4,356876,1,1,1),('COL-498','Mustang','Rojo',2010,5,300456,2,2,7),('DEL-34-56','i10','Gris',2015,4,75897,3,8,3),('FDD-31-72','Camry','Blanco',2000,6,379651,3,6,5),('LIZ-501','Lobo','Negro',2005,3,267412,1,2,6),('RDG-541','Kicks','Blanco',2016,4,91756,2,5,2),('SAQ-185','Beetle','Amarillo',2007,5,267561,2,1,9),('TTL-45-66','SAIC','Cafe',2017,8,15896,3,3,8),('XET-737','Transporter Kombi','Blanco',1985,8,478512,1,1,10);
...
INSERT INTO `cliente` VALUES (8,'FLRDCR870726');
...
INSERT INTO `proveedor` VALUES (1,'Volkswagen\r'),(2,'Ford\r'),(3,'General Motors \r'),(5,'Nissan\r'),(6,'Toyota\r'),(7,'Renault\r'),(8,'Hunday\r'),(9,'KIA\r'),(10,'Seat');
...
-- Dump completed on 2018-03-08 22:30:11
